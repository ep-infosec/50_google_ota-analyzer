...
declare module '@zip.js/zip.js/dist/zip.js' {
  ...
  export class ZipReader {
    ...
    getEntries(
      options?: OnprogressEntryOption | GetEntriesOptions
    ): Promise<Entry[]>
    close(): Promise<any>
  }
  ...
  export interface Entry {
    ...
    getData?(
      writer: Writer,
      options?: OnprogressEntryDataOption | ZipReaderOptions
    ): Promise<any>
  }
  ...
  export class ZipWriter {
    ...
    public add(
      name: string,
      reader: Reader,
      options?: OnprogressEntryDataOption | AddDataOptions | ZipWriterOptions
    ): Promise<Entry>
    public close(
      comment?: Uint8Array,
      options?: OnprogressEntryOption | CloseOptions
    ): Promise<any>
  }
  ...
  export interface ZipDirectoryEntry extends ZipEntry {
    ...
    importBlob(
      blob: Blob,
      options?: ZipReaderOptions | GetEntriesOptions
    ): Promise<void>
    importData64URI(
      dataURI: string,
      options?: ZipReaderOptions | GetEntriesOptions
    ...
    importHttpContent(
      url: string,
      options?: ZipReaderOptions | GetEntriesOptions | HttpOptions
    ): Promise<void>
    ...
    exportUint8Array(
      options?: ZipWriterOptions | ExportOptions
    ): Promise<Uint8Array>
  }
